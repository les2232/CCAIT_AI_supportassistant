...
PILOT_EVAL_CASES = [
    ...
    {"question": "I am not getting my verification code", "expected_behavior": "direct", "expected_article": "mfa-account-security.txt", "notes": "verification issue escalation"},
    {"question": "How do I access D2L?", "expected_behavior": "direct", "expected_article": "d2l.txt", "notes": "D2L student access"},
    ...
    {"question": "Student email not working", "expected_behavior": "direct", "expected_article": "student-email-troubleshooting.txt", "notes": "broad student email troubleshooting"},
    {"question": "My student email is not working", "expected_behavior": "direct", "expected_article": "student-email-troubleshooting.txt", "notes": "broad student email troubleshooting variant"},
    ...
    {"question": "Outlook is not loading", "expected_behavior": "direct", "expected_article": "student-email-troubleshooting.txt", "notes": "Outlook app loading issue"},
    ...
    {"question": "can't log in", "expected_behavior": "disambiguation", "expected_options": ["D2L", "Student email", "MyCCA", "Campus computer", "Wi-Fi", "MFA/Auth", "I'm not sure"], "notes": "generic login ambiguity"},
    ...
    {"question": "problem with login", "expected_behavior": "disambiguation", "expected_options": ["D2L", "Student email", "MyCCA", "Campus computer", "Wi-Fi", "MFA/Auth", "I'm not sure"], "notes": "generic login wording"},
